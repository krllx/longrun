...
Скилл, CLI и восемь хуков. Сессии Claude Code, работающие над одним проектом, видят общую картину и статус друг друга, каждая копит свою часть, которая не теряется при компакции, `/clear` и перезапуске, и при необходимости передают работу той сессии, у которой больше контекста.
